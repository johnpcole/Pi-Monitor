...
# =========================================================================================
	...
	def gettorrentdata(self, torrentid):
		...
		return ({'total_size': 1767583673,
				...
				'files': ({'index': 0, 'path': torrentid + '/Hd.mp4', 'offset': 0, 'size': 1767473159}, {'index': 1, 'path': 'Housebound (2014) [1080p]/WWW.YTS.RE.jpg', 'offset': 1767473159, 'size': 110514}, {'index': 22, 'path': 'Housebound (2014) [1080p]/WWW.YTS.RE.jpg', 'offset': 1767473159, 'size': 110514}),
